...
export default function SignUpPage() {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(127,29,29,0.3),transparent_40%),linear-gradient(180deg,#120909_0%,#050505_100%)] px-6 pb-12 pt-32 text-white md:px-12">
      <div className="mx-auto flex w-full max-w-5xl items-center justify-center">
        <section className="w-full max-w-md rounded-3xl border border-white/10 bg-white/5 p-8 shadow-2xl shadow-black/40 backdrop-blur-xl">
          ...
          <p className="mt-3 text-sm text-white/65">
            Save favorites, track bookings, and move through checkout with less friction.
          </p>
          ...
          <p className="mt-6 text-sm text-white/65">
            ...
            <Link className="text-red-300 transition hover:text-red-200" href="/sign-in">
              Sign in
            </Link>
          </p>
        </section>
